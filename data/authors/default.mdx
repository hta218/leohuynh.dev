...
Ex Frontend Engineer at [Coc Coc](https://coccoc.com/) - **#1** web browser in **Viet Nam** with more than **25M users**.

See more about my working experiences at [my resume](/resume).

Currently a Shopify Software Engineer in an awesome team at [Insights Studio](https://insights.is/), focusing on developing **Shopify's apps and themes**.
