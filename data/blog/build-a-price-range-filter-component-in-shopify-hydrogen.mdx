...
date: '2025-03-11'
tags: ['shopify', 'hydrogen', 'price-range-filter', 'remix', 'react-router']
draft: false
...
<video
  controls
  aria-label="Price range filter component in Shopify Hydrogen"
  className="h-auto w-full object-cover"
  style={{ aspectRatio: 16 / 9 }}
>
  <track
    kind="captions"
    src="https://monosnap.com/file/fyWRrozRsN8TBc5qMx2QqtoTFpOP5n"
    label="English"
    srcLang="en"
    default
  />
  <source src="https://monosnap.com/file/fyWRrozRsN8TBc5qMx2QqtoTFpOP5n" type="video/mp4" />
</video>
