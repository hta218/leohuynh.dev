...
draft: false
summary: "Crawling Goodreads books data from user's RSS feed or CSV export and parse to JSON in Node.js"
images:
  [
...
Regardless of the method, the goal is to parse the data into a consistent format. Here is the target `GoodreadsBook` type definition:
