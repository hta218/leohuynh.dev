...
Vậy tại sao truy cập vào ~~**domain name**~~ địa chỉ dễ nhớ hơn chúng ta vẫn đến được nơi cần đến 👀??
...
Đến đây anh em đã hoàn thiện được 90% website của mình rồi <Twemoji emoji="astonished-face" />, [phần tiếp theo](/posts/deploy-and-config-website-on-namecheap-part-2) mình sẽ hướng dẫn ~~90%~~ 10% còn lại <Twemoji emoji="smiling-face-with-tear" /> bao gồm:
