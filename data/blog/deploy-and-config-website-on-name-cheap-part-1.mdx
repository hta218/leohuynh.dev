...
draft: false
summary: 'Trước giờ mình luôn muốn sở hữu 1 site cá nhân, nhưng vì mình không có thời gian nên đợt này nghỉ việc, ở nhà cách ly mới tìm hiểu để làm đc...'
...
Mặc dù namecheap đã có [hướng dẫn](https://www.namecheap.com/resource-center/tutorials/building-your-first-website/) đầy đủ để build 1 website from scratch nhưng bơi <Twemoji emoji="man-swimming" /> trong 1 đống document là k dễ dàng gì.
...
Đến đây anh em đã hoàn thiện đc 90% website của mình rồi <Twemoji emoji="astonished-face" />, [phần tiếp theo](/posts/deploy-and-config-website-on-namecheap-part-2) mình sẽ hướng dẫn ~~90%~~ 10% còn lại <Twemoji emoji="smiling-face-with-tear" /> bao gồm:
