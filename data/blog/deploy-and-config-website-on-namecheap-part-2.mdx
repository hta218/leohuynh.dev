...
images: ['/static/images/server-2.jpg']
bannerAuthor: 'Thomas Jensen'
bannerUrl: 'https://unsplash.com/photos/black-network-switch-with-cables-ISG-rUel0Uw'
authors: ['default']
---
...
## What’s on the server <Twemoji emoji="eyes" size="" />?
