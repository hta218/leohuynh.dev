...
<div className="flex">
  <img
    ...
    alt="LinkedIn profile headline and summary section filled out with a clear job title"
    style={{ width: '33.33%', objectFit: 'cover', height: '200px' }}
  />
  <img
    src="/static/images/linkedin4.png"
    alt="LinkedIn work experience section listing detailed roles and achievements"
    style={{ width: '33.33%', objectFit: 'cover', height: '200px' }}
  />
  <img
    src="/static/images/linkedin5.jpg"
    alt="LinkedIn skills and endorsements section highlighting core developer skills"
    style={{ width: '33.33%', objectFit: 'cover', height: '200px' }}
  />
</div>
