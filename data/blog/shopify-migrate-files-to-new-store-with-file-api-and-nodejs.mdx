...
- **Assets**: là toàn bộ file trong store của bạn (Có thể xem ở **Admin / Settings / Files**) bao gồm image, video, font... đây là những assets sử dụng cho theme settings, blog post và page. (Ảnh và video của product đã được tự động migrate khi upload file **CSV** rồi!)
  ...
  Và vấn đề mình gặp phải khi migrate đống assets này là:
      ...
      - Sau khi upload xong thì phải vào settings của theme và page chọn lại thì mới work
...
<Twemoji emoji="keycap-digit-one" /> Tạo **Private App**
...
<Twemoji emoji="keycap-digit-two" /> Lấy **Access Token**
...
Copy `password` trong section **Admin API** của **Private App** vừa tạo, đây chính là `access_token` chúng ta cần.

<Twemoji emoji="keycap-digit-three" /> Bắn **GraphQL** `request` với **Postman**
...
- Request URL: `https://your-store.myshopify.com/admin/api/2021-07/graphql.json`

  <br /> với `2021-07` là API version support File API
...
<br />(<Twemoji emoji="warning" /> phần tử cuối cùng nhé!)
...
Và trong URL của file lấy được với **GraphQL** đã có chứa sẵn tên file trong đó rồi: `"https://cdn.shopify.com/s/files/1/0561/2742/2636/files/fav_icon_dark_1.png?v=1618297070"`
...
<Twemoji emoji="party-popper" /> đến đây là hoàn thiện quá trình migrate rồi, anh em kiểm tra kết
quả trên store mới nhé!
...
Đây là con theme tâm huyết của anh em trong nhiều tháng phát triển, với [>50 demos](https://demo.minimog.co/), rất nhiều tính năng và design thì siêu đẹp <Twemoji emoji="smiling-face-with-heart-eyes" />

![minimog-top-1](/static/images/minimog-top-1.jpg)
...
Và đặc biệt là đang rất hạt dẻ - chỉ **$29** <Twemoji emoji="smiling-face-with-heart-eyes" /> (chuẩn bị tăng lên **99**)

Anh em bạn gì làm Shopify ủng hộ team mình vài sale nhé <Twemoji emoji="folded-hands" /><Twemoji emoji="folded-hands" /> (Thông tin [ở đây](https://minimog.co/?utm_source=leo))
