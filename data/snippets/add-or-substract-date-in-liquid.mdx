---
title: 'Adding/substracting days in Liquid'
date: '2021-08-29'
type: 'liquid'
draft: false
...
```html
<!-- Liquid -->
{% assign days = 4 %} {% assign ms = days | times: 24 | times: 60 | times: 60 %} {% assign now =
'now' | date: "%s" %} {% assign today = now | date: "%b %d" %} {% assign before = now | minus: ms |
date: "%b %d" %} {% assign after = now | plus: ms | date: "%b %d" %}
