 ...
 * and viewBox are projected at build time with d3-geo's geoMercator (see the
 * page) from a GeoJSON that carries the real Hoàng Sa / Trường Sa geometry, so
 * the archipelagos land at their true positions. Hovering shows the province
 * name in a tooltip at the cursor; clicking selects it and fills the detail
 * card, which floats over the empty sea to the right of the mainland.
 */
