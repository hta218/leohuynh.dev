...
export default function VietnamMapLib({ provinces, viewBox }: Props) {
  ...
  return (
    <figure className="m-0">
      <div ref={containerRef} className="relative mx-auto w-full md:pl-[6%]">
        <svg
          viewBox={viewBox}
          role="img"
          aria-label="Map of Vietnam's provinces, shaded by places I've visited"
          className="block h-auto w-full max-h-[80vh] select-none"
